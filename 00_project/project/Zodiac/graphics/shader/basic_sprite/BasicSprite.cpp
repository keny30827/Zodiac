...
void CBasicSprite::Init(CGraphicsController& graphicsController)
{
	...
	// シェーダービルド.
	{
		...
		// 頂点シェーダー.
		{
			ret = D3DCompileFromFile(
				L"shader\\basic_sprite\\BasicSpriteVS.hlsl",
				nullptr,
		...
		{
			ret = D3DCompileFromFile(
				L"shader\\basic_sprite\\BasicSpritePS.hlsl",
				nullptr,
				D3D_COMPILE_STANDARD_FILE_INCLUDE,
				"main",
				"ps_5_0",
