...
void CBasicModel::Init(CGraphicsController& graphicsController)
{
	...
	// シェーダービルド.
	{
		...
		// 頂点シェーダー.
		{
			ret = D3DCompileFromFile(
				L"shader\\basic_model\\BasicModelVS.hlsl",
				nullptr,
...
void CBasicModel::Update()
{
}

void CBasicModel::RenderSetup(CCommandWrapper& commandWrapper, CHeapWrapper& heapWrapper)
{
	// コマンドリストへの設定.
	{
		// パイプライン設定.
