...
bool CApplication::Init(SApplicationOption option)
{
	...
	// 事前設定.
	{
		...
		// ちょっと雑だがライト用意.
		{
			...
			m_light[0].color = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);

			m_light[1].pos = DirectX::XMFLOAT4(-5.0f, 5.0f, 0.0f, 1.0f);
			m_light[1].color = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);

			m_light[2].pos = DirectX::XMFLOAT4(-5.0f, 5.0f, 5.0f, 1.0f);
			m_light[2].color = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);

			m_light[3].pos = DirectX::XMFLOAT4(5.0f, 5.0f, -5.0f, 1.0f);
			m_light[3].color = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);

			m_light[4].pos = DirectX::XMFLOAT4(5.0f, 5.0f, 0.0f, 1.0f);
			m_light[4].color = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
